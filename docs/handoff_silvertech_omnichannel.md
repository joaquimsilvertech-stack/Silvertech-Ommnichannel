...
- **Commit hashes de referência:** `074c212` P28 · `3a9991f` micro-fix e-mail · `2556e35` P29 · `a044ac2` micro-fix P29 · `0ad3ed5` `.env.example` · `a11e8c2` Swagger.
